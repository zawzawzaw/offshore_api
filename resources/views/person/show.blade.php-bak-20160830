				...
				<div id="edit_client">
					<div class="labels">
						...
						<div class="row company-only">
							...
							<div class="col-md-8">{{ $person->company_name }}</div>
						</div>
						<div class="row company-only">
							<div class="col-md-4"><p>Jurisdiction</p></div>
							<div class="col-md-8">{{ $person->jurisdiction }}</div>
						</div>
						<div class="row company-only">
							<div class="col-md-4"><p>Company registration number</p></div>
							<div class="col-md-8">{{ $person->reg_no }}</div>
						</div>		
						@endif						
						<div class="row">
							<div class="col-md-4"><p>Title</p></div>
							<div class="col-md-8">{{ $person->title }}</div>
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-8">{{ (strtotime($person->passport_expiry) < 0) ? $person->passport_expiry : date('d/m/y', strtotime($person->passport_expiry)) }}</div>
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-8">{{ (strtotime($person->account_registered) < 0) ? $person->account_registered : date('d/m/y', strtotime($person->account_registered)) }}</div>
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-8">{{ (strtotime($person->relationship_commenced) < 0) ? $person->relationship_commenced : date('d/m/y', strtotime($person->relationship_commenced)) }}</div>
						</div>
						<div class="row">
							<div class="col-md-4"><p>Relationship ended </p></div>
							<div class="col-md-8">{{ (strtotime($person->relationship_ended) < 0) ? $person->relationship_ended : date('d/m/y', strtotime($person->relationship_ended)) }}</div>
						</div>
						<div class="row">
							<div class="col-md-4"><p>Passport copy</p></div>
							<div class="col-md-8"><a target="_blank" href="{{ url('public/uploads/'.$person->person_code.'/'.$person->passport_copy) }}">{{ $person->passport_copy }}</a></div>
						</div>
						<div class="row">
							<div class="col-md-4"><p>Proof of address</p></div>
							<div class="col-md-8"><a target="_blank" href="{{ url('public/uploads/'.$person->person_code.'/'.$person->proof_of_address) }}">{{ $person->proof_of_address }}</a></div>
						</div>
						<div class="row">
							<div class="col-md-4"><p>Bank reference</p></div>
							<div class="col-md-8"><a target="_blank" href="{{ url('public/uploads/'.$person->person_code.'/'.$person->bank_reference) }}">{{ $person->bank_reference }}</a></div>
						</div>
						<div class="row">
							<div class="col-md-4"><p>Professional reference</p></div>
							<div class="col-md-8"><a target="_blank" href="{{ url('public/uploads/'.$person->person_code.'/'.$person->professional_reference) }}">{{ $person->professional_reference }}</a></div>
						</div>
						<div class="row">
